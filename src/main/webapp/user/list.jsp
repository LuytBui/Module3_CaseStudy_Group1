...
<head>
    ...
    <link type="text/css" rel="stylesheet" href="style/blog-list.css">
    <link type="text/css" rel="stylesheet" href="style/user-list.css">
</head>
<body>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <c:if test="${user.isAdmin()}">
                                                        <a class="btn btn-secondary" href="/users?action=unsetAdmin&id=${user.id}">Unset admin</a>
                                                    </c:if>
                                                    <c:if test="${!user.isAdmin()}">
                                                        <a class="btn btn-primary" href="/users?action=setAdmin&id=${user.id}">Set admin</a>
                                                    </c:if>
                                                </td>

                                                <td>
                                                    <c:if test="${user.status == true}">
                                                        <a class="btn btn-danger" href="/users?action=block&id=${user.id}">Block user</a>
                                                    </c:if>
                                                    <c:if test="${user.status == false}">
                                                        <a class="btn btn-success" href="/users?action=unblock&id=${user.id}">Unblock user</a>
                                                    </c:if>
                                                </td>
